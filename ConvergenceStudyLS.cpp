...
int main()
{
    ...
    for (int i = 2000; i <= 4000; i += 2000) vecSim.push_back(i);
    ...
    // Out->Vec2CSV(allPricesLSCall, "Outputs/LS_Simulations_Convergence_CallLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo for a Call in: Outputs/LS_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;

    // Out->Vec2CSV(allPricesLSPut, "Outputs/LS_Simulations_Convergence_PutLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo for a Put in: Outputs/LS_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // ==========================================================================================================
    ...
    // };
    // // === Output the simulations ===
    // Out->Vec2CSV(allPricesLSCall, "Outputs/LS_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo with Control Variate for a Call in: Outputs/LS_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;
    
    // Out->Vec2CSV(allPricesLSPut, "Outputs/LS_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo with Control Variate for a Put in: Outputs/LS_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // ==========================================================================================================
    ...
    // };
    // // === Output the simulations ===
    // Out->Vec2CSV(allPricesLSCall, "Outputs/LS_Antithetic_Simulations_Convergence_CallLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo with Antithetic for a Call in: Outputs/LS_Antithetic_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;
    
    // Out->Vec2CSV(allPricesLSPut, "Outputs/LS_Antithetic_Simulations_Convergence_PutLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo with Antithetic for a Put in: Outputs/LS_Antithetic_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // ==========================================================================================================
    ...
    // };
    // // === Output the simulations ===
    // Out->Vec2CSV(allPricesLSCall, "Outputs/LS_Antithetic_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo with Antithetic and Control Variate for a Call in: Outputs/LS_Antithetic_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;
    
    // Out->Vec2CSV(allPricesLSPut, "Outputs/LS_Antithetic_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Monte Carlo with Antithetic and Control Variate for a Put in: Outputs/LS_Antithetic_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // ==========================================================================================================
    ...
    // };
    // // === Output the simulations ===
    // Out->Vec2CSV(allPricesLSCall, "Outputs/QuasiLS_Convergence_CallLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Quasi Monte Carlo for a Call in: Outputs/QuasiLS_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;

    // Out->Vec2CSV(allPricesLSPut, "Outputs/QuasiLS_Convergence_PutLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Quasi Monte Carlo for a Put in: Outputs/QuasiLS_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // ==========================================================================================================
    ...
    // === Output the simulations ===
    Out->Vec2CSV(allPricesLSCall, "Outputs/QuasiLS_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv");
    std::cout << "Outputting the results of Quasi Monte Carlo with Control Variate for a Call in: Outputs/Quasi_LS_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;

    Out->Vec2CSV(allPricesLSPut, "Outputs/Quasi_LS_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv");
    std::cout << "Outputting the results of Quasi Monte Carlo with Control Variate for a Put in: Outputs/Quasi_LS_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // ==========================================================================================================
    ...
    // };
    // // === Output the simulations ===
    // Out->Vec2CSV(allPricesLSCall, "Outputs/QuasiLS_Antithetic_Simulations_Convergence_CallLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Quasi Monte Carlo with Antithetic for a Call in: Outputs/QuasiLS_Antithetic_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;

    // Out->Vec2CSV(allPricesLSPut, "Outputs/QuasiLS_Antithetic_Simulations_Convergence_PutLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Quasi Monte Carlo with Antithetic for a Put in: Outputs/QuasiLS_Antithetic_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // ==========================================================================================================
    ...
    // };
    // // === Output the simulations ===
    // Out->Vec2CSV(allPricesLSCall, "Outputs/QuasiLS_Antithetic_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Quasi Monte Carlo with Antithetic and Control Variate for a Call in: Outputs/QuasiLS_Antithetic_ControlVariate_Simulations_Convergence_CallLaguerreBermudanBasket.csv" << std::endl;

    // Out->Vec2CSV(allPricesLSPut, "Outputs/QuasiLS_Antithetic_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv");
    // std::cout << "Outputting the results of Quasi Monte Carlo with Antithetic and Control Variate for a Put in: Outputs/QuasiLS_Antithetic_ControlVariate_Simulations_Convergence_PutLaguerreBermudanBasket.csv" << std::endl;
    // // ==========================================================================================================
